...
define( 'CODETOT_OPTIMIZATION_VERSION', '1.7.0' );
 ...
 */
require CODETOT_OPTIMIZATION_PATH . 'includes/class-codetot-optimization-rest.php';
add_action( 'rest_api_init', array( new Codetot_Optimization_REST(), 'register_routes' ) );
